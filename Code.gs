var id = 'SpreadSheetsID'; 
// the SpreadSheetID is in the URL like in this example --> 'docs.google.com/spreadsheets/d/SpreadSheetID/edit'

var sheet = SpreadsheetApp.openById(id).getActiveSheet();

var MAX_ROWS = 10;     // max number of data rows to display
